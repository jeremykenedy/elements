...
function processNode(node, annotations) {
    if (annotations) {
        ...
        return Object.assign(Object.assign({}, node), { annotations, data: Object.assign(Object.assign({}, data), { hName: node.type, hProperties: Object.assign(Object.assign({}, (data.hProperties || {})), annotations) }) });
    }
    return node;
}
const toSpec = (root) => {
