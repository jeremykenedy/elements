(function (global, factory) {
  ...
  var Heading = React.memo(function Heading(_a) {
    var size = _a.size,
  ...
  var LinkHeading = React.memo(function LinkHeading(_a) {
    var id = _a.id,
        children = _a.children,
        className = _a.className,
